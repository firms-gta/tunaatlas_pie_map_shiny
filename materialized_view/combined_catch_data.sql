...
WHERE metadata.identifier LIKE '%global%' AND  metadata.identifier LIKE '%1950_2023%' AND metadata.id_metadata = fact.id_metadata AND metadata.id_metadata = fact.id_metadata
