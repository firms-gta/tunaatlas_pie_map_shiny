---
title: "Indicators for Fisheries: Use Case of the Tuna Atlas"
...
The application allows users to explore different indicators related to tuna fisheries. To begin the exploration, users are invited to select a dataset and apply the desired filters. Upon submission, the application will render the selected indicators, which may include visual representations such as maps and graphs.
